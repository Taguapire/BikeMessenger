...
namespace BikeMessenger
{
    class Bm_Personal_Database
    {
        ...
        public bool Bm_Personal_Modificar()
        {
            ...
            StrModificar_Personal += "RUTID = '" + BK_RUTID + "' AND ";
            StrModificar_Personal += "DIGVER = '" + BK_DIGVER + "'";
            BK_Cmd_Personal = new SQLiteCommand(StrModificar_Personal, BM_Connection);
            BK_Cmd_Personal.ExecuteNonQuery();
            return true;
        }

        // Procedimiento Borrar Empresa
        public bool Bm_Personal_Borrar()
        {
            StrBorrar_Personal = "DELETE FROM PERSONAL ";
            StrBorrar_Personal += "WHERE ";
            StrBorrar_Personal += "RUTID = '" + BK_RUTID + "' AND ";
            StrBorrar_Personal += "DIGVER = '" + BK_DIGVER + "'";
